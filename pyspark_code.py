...
AmazonS3_node1699764784838 = glueContext.create_dynamic_frame.from_catalog(
    database="de_youtube_raw",
    table_name="raw_statistics",
    transformation_ctx="AmazonS3_node1699764784838",
    push_down_predicate = predicate_pushdown
)

# Script generated for node Change Schema
ChangeSchema_node1699765226409 = ApplyMapping.apply(
    frame=AmazonS3_node1699764784838,
    mappings=[
